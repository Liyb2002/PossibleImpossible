...
#start produce
production_list = produce.execute_model(foreground_intersection, object_list, 1)
# production_list += produce.execute_model(background_intersection, object_list, 5)
